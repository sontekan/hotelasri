...
class UserController extends Controller
{
    ...
    {
        $user = User::all();
        return view ('pages.pengguna.index', ['user' => $user ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('user/create')->with('success', 'Data Pengguna Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('user')->with('success', 'Data Pengguna Berhasil Diperbaharui');
    }
