            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 text-end border-bottom border-lg-0">
                                <p class="h3 fw-semibold">Invoice :</p>
                                <h5>No Invoice : {{$data->order_id}}/{{date('Y',strtotime ($data->transaction_time))}}</h5>
                                <h5>Tamu     : {{$data->tamu}}</h5>
                                <h5>Check-in : {{date('d/m/Y',strtotime ($data->checkin))}}</h5>
                                <h5>Check-out: {{date('d/m/Y',strtotime ($data->checkout))}}</h5>
                            </div>
                        </div>
                        <div class="row pt-5">
                            <div class="col-lg-6">
                    ...
                    <div class="card-footer text-end">
                        <button type="button" class="btn btn-danger mb-1" onclick="javascript:window.print();"><i class="si si-printer"></i> Cetak</button>
